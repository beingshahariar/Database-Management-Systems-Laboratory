...
<head>
    ...
    <style>
        /* CSS for Modals (copied from quick_view.php and menu.php) */
        .modal {
            display: none;
            position: fixed;
            z-index: 1000;
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <form action="" method="post" class="box">
            ...
            <div class="button-group" style="display: flex; gap: 5px; margin-top: 1rem;">
            
                <?php if(isset($fetch_products['carbon_value']) && $fetch_products['carbon_value'] !== null && $fetch_products['carbon_value'] > 0): ?>
                <button type="button" class="impact-btn" onclick="openCarbonModal('<?= $fetch_products['id']; ?>')" style="flex-grow: 1;">
                    <i class="fa-solid fa-cloud"></i> Carbon
                </button>
                <?php endif; ?>

                <?php if(isset($fetch_products['calories']) && $fetch_products['calories'] !== null && $fetch_products['calories'] > 0): ?>
                <button type="button" class="calories-btn" onclick="openCaloriesModal('<?= $fetch_products['id']; ?>')" style="flex-grow: 1;">
...
<script>
// 🟢 Carbon Modal Logic (Copied from menu.php)
...
// 🔥 Calories Modal Logic (Copied from menu.php)
...
// Close modals if clicked outside (Copied from menu.php)
